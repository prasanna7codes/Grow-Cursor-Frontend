                          ...
                          <TableCell>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                              <AutoSaveTextField
                                ...
                                onSave={(val) => updateManualField(order._id, 'beforeTax', val === '' || val === '-' ? null : parseFloat(val))}
                              />
                              <IconButton
                                size="small"
                          ...
                          <TableCell>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                              <AutoSaveTextField
                                ...
                                onSave={(val) => updateManualField(order._id, 'estimatedTax', val === '' || val === '-' ? null : parseFloat(val))}
                              />
                              <IconButton
                                size="small"
                          ...
                          <TableCell sx={{ minWidth: 200 }}>
                            <Stack direction="row" spacing={1} alignItems="center">
                              <AutoSaveTextField
                                ...
                                type="text"
                                onSave={(val) => updateManualField(order._id, 'amazonRefund', val === '' || val === '-' ? null : parseFloat(val))}
                                sx={{ minWidth: 100 }}
                              />
                              <IconButton
                                size="small"
