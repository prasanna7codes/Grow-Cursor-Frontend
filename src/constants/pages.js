...
export const PAGE_REGISTRY = [
  ...
  { id: 'PriceChangeOrderCheck', name: 'Price Change Order Check', path: '/price-change-order-check', category: 'finance', defaultRoles: ['superadmin', 'fulfillmentadmin', 'hoc', 'compliancemanager'] },
